...
1. How would you describe acessibility on the web to someone new to programming?
    ...
    accessibility is used through html to make sense of things to people with disabilities a good example is putting a desription for each photo
    so they can know whats in front of them
...
3. How would you explain the concept of a variable to someone new to programming?
    ...
    It's a place holder to store or munipulate data
